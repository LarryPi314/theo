...
journals.post('/createJournal', async (req, res) => {
    ...
    */
    try {
        ...
        journal.title = await askOpenAI(generateTitlePrompt + journal.text);
        console.log("Created the journal's title through openAI!")
        ...
        console.log("Added the journal to firebase?")
        ...
        const keywordPhrasesString = await askOpenAI(keywordPhrasesPromptComplete);
        
        console.log("Prompted for keyword phrases and got response: ", keywordPhrasesString);
        ...
        console.log("Just finished trying to find connections")

        // question generation annotations
        let questionRes = await askOpenAI(generateQuestionPrompt + journal.text);
        ...
        console.log("Just finished prompting openai for further probing questions")

        // TODO: add events extraction to the annotation set
        let eventRes = await askOpenAI(generateEventPrompt + journal.text);
        ...
        console.log("Just finished prompting openai for events")
        
        console.log("Here are all the annotations: ", annotations);
